...
def _iniatilize_clients_from_storage():
...
def _get_client_id():
    ...
    while not client_id:
        client_id = int(input('What is the ID client: '))
        if client_id == 0:
            break
